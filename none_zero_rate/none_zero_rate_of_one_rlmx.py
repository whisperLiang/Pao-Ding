...
if __name__ == '__main__':
    ...
    #cbar.set_label('Number of Frames', fontproperties=lg)
    plt.text(4, 0.09, f'{sparse}%', ha='center', va='bottom', fontsize=12)
    plt.quiver(4, 0.5, 0, -1, color='b', scale=3, width=0.02)
    ...
    cbar.ax.tick_params(labelsize=13)
    cbar.set_label('Number of Frames', fontproperties=lg)
    plt.text(8, 0.09, f'{sparse}%', ha='center', va='bottom', fontsize=12)
    plt.quiver(6, 0.5, 0, -1, color='b', scale=3, width=0.02)
    ...
    plt.text(35, 0.09, f'{sparse}%', ha='center', va='bottom', fontsize=12)
    ...
    plt.quiver(20, 0.5, 0, -1, color='b', scale=3, width=0.02)
    # plt.show()
    plt.savefig('none zero rate of one rl.png')
  ...
  #  plt.plot([0.5,0.5],[0,1], 'o--',linewidth=2, color='orchid')
   ...
   # plt.text(0.5, 0.1, 'better', fontsize=20, )
    # plt.show()
    plt.savefig('none zero rate of one cdf.png')