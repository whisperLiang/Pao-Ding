...
if __name__ == '__main__':
    ...
    #cbar.set_label('Number of Frames', fontproperties=lg)
    plt.text(2, 0.09, f'{sparse}%', ha='center', va='bottom', fontsize=10)
    ...
    cbar.ax.tick_params(labelsize=13)
    cbar.set_label('Number of Frames', fontproperties=lg)
    plt.text(4, 0.09, f'{sparse}%', ha='center', va='bottom', fontsize=10)
    ...
    plt.quiver(20, 0.5, 0, -1, color='b', scale=3, width=0.02)
    # plt.show()
    plt.savefig('none zero rate of one mx.png')
